...
import numpy as np
import cv2
from QR_code_function import detect_qr_video
...
def run(
    ...
    try:
        while True:
            ...
            # yolo 모델을 위한 
            color_image = cv2.resize(origin_color_image , (640,640))
            ...
            # qr_frame , data  = detect_qr_video(origin_color_image)
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'config/best.pt', help='model path or triton URL')
