...
# image = cv2.imread("./img/tmp17.jpg")
...
# def FindFourPoint(corner_image):
...
# p1, p2 ,p3,p4 = FindFourPoint(corner_image)
...
#         cv2.circle(image , p4 , 1 , (255,0,0) , -1)
#         # print("angle : " , angle)
#         final_angle += angle
...
#     p1 = (lambda x : x-p1[1])(p1)
    
#     RightSidePoint = new_slice.shape[1]-1 , ((new_slice.shape[1]-1) - p1[0])*math.tan(math.radians(-final_angle)) 
...
#     LeftSidePoint = 0 , (p1[0])*math.tan(math.radians(90-abs(final_angle))) 
#     print(f"LeftSidePoint : " , LeftSidePoint)
#     LeftSidePoint = np.int16(LeftSidePoint)
    
#     LastPoint = math.sqrt( ((RightSidePoint[0])-p1[0])**2 + (RightSidePoint[1] - p1[1])**2)*math.cos(math.radians(-final_angle)) , new_slice.shape[0]-1
...
#     cv2.line(new_slice , p1 , RightSidePoint , (0,255,0) ,2)
#     cv2.line(new_slice, p1 , LeftSidePoint , (0,255,0) , 2)
...
#     # BotomPoint = (image.shape[0]-1-p2[1])*math.tan(math.radians(final_angle)) + p2[0],  image.shape[0] -1
#     # print(f"BotomPoint : " , BotomPoint)
#     # BotomPoint = np.int16(BotomPoint)
    
#     # p2의 x좌표만큼 이미지 사이즈 줄이기 
#     spare = p2[0]
#     new_slice = image[spare:image.shape[0]-spare , spare: image.shape[1]-spare]
#     p2 = (lambda x : x-p2[0])(p2)
    
#     RightSidePoint =  (p2[1])/math.tan(math.radians(angle)) , 0
#     print(f"RightSidePoint : " , RightSidePoint)
#     print(math.atan2(-(RightSidePoint[1]-p2[1]  ) , RightSidePoint[0] - p2[0])*180/math.pi)
#     RightSidePoint = np.int16(RightSidePoint)
    
#     BotomPoint = (new_slice.shape[0]-1-p2[1])*math.tan(math.radians(final_angle)),  new_slice.shape[0] -1
#     print(f"BotomPoint : " , BotomPoint)
#     BotomPoint = np.int16(BotomPoint)
    
#     LastPoint = math.sqrt( ((RightSidePoint[0])-p2[0])**2 + (RightSidePoint[1] - p2[1])**2)*math.cos(math.radians(angle))+BotomPoint[0] , (new_slice.shape[0]-1)-math.sqrt( ((RightSidePoint[0])-p2[0])**2 + (RightSidePoint[1] - p2[1])**2)*math.sin(math.radians(angle))
#     LastPoint = np.int16(LastPoint)
#     ## 길이 확인
...
#     cv2.line(new_slice , p2 , RightSidePoint , (0,255,0) ,2)
#     cv2.line(new_slice, p2 , BotomPoint , (0,255,0) , 2)
...
#         y,x = np.where(corner_image ==255)
#         # candidate = [p1[0]+10 ,p1[0]+20 , p1[0]+30 , p1[0]+40 , p1[0]+50]
#         candidate = range(p1[0]+10 , p1[0]+20 , 2)
#         final_angle = 0 
#         for i in candidate:
#             RightX_index = np.where(x == i)
#             RightY = min(y[RightX_index])
...
#         candidate = range(p2[0]+10 , p2[0]+30 , 2)
#         final_angle = 0 
#         for i in candidate:
#             RightX_index = np.where(x == i)
#             RightY = min(y[RightX_index])
#             p4 = (i , RightY)
#             angle = math.atan2(-(p4[1] - p2[1]) , p4[0] - p2[0])*180/math.pi
#             cv2.circle(image , p4 , 2 , (0,0,255) , -1)
#             print("angle : " , angle)
#             final_angle += angle
#         final_angle /= len(candidate)
#         print("mean angle : " , final_angle)
